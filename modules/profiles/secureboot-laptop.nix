...
# Boot with TPM-unlocked LUKS (system/boot/secureboot-tpm.nix, which intelNuc
# imports too), the laptop peripherals (LED and IIO access, printing, QMK), a
# 16 GB swapfile for hibernation, and the smaller journal.
...
{pkgs, ...}: {
  imports = [../system/boot/secureboot-tpm.nix];
