{
  ...
  # Look, persistence and the theme, shared with the homeserver's
  # zellij-server.nix. The keybind map and plugins below are desktop-only.
  commonKdl = import ./zellij-common.nix {
